...
- [Kopia](https://kopia.io/), a fast, secure backup tool with deduplication, encryption, and compression. Includes both the WebUI/Server as well as manual systemd-timers for snapshots. Available as [services.kopia](#opt-services.kopia.backups).
